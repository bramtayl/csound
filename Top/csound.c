...
#include <signal.h>                  // for size_t, psignal, SIGPIPE, signal
...
#include <stdio.h>                   // for NULL, fprintf, vsnprintf, vfprintf
...
#include "csound.h"                  // for CSOUND, PUBLIC, Str, csoundUnloc...
