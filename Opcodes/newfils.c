...
static OENTRY localops[] =
  {
    {"mvchpf", sizeof(mvchpf24), 0, 3, "a", "ako",
     (SUBR) mvchpf24_init, (SUBR) mvchpf24_perf, NULL, NULL},
    {"mvchpf", sizeof(mvchpf24), 0, 3, "a", "aao",
     (SUBR) mvchpf24_init, (SUBR) mvchpf24_perf_a, NULL, NULL},
    {"mvclpf1", sizeof(mvclpf24), 0, 3, "a", "akko",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf1, NULL, NULL},
    {"mvclpf1", sizeof(mvclpf24), 0, 3, "a", "aako",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf1_ak, NULL, NULL},
    {"mvclpf1", sizeof(mvclpf24), 0, 3, "a", "akao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf1_ka, NULL, NULL},
    {"mvclpf1", sizeof(mvclpf24), 0, 3, "a", "aaao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf1_aa, NULL, NULL},
    {"mvclpf2", sizeof(mvclpf24), 0, 3, "a", "akko",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf2, NULL, NULL},
    {"mvclpf2", sizeof(mvclpf24), 0, 3, "a", "aako",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf2_ak, NULL, NULL},
    {"mvclpf2", sizeof(mvclpf24), 0, 3, "a", "akao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf2_ka, NULL, NULL},
    {"mvclpf2", sizeof(mvclpf24), 0, 3, "a", "aaao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf2_aa, NULL, NULL},
    {"mvclpf3", sizeof(mvclpf24), 0, 3, "a", "akko",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf3, NULL, NULL},
    {"mvclpf3", sizeof(mvclpf24), 0, 3, "a", "aako",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf3_ak, NULL, NULL},
    {"mvclpf3", sizeof(mvclpf24), 0, 3, "a", "akao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf3_ka, NULL, NULL},
    {"mvclpf3", sizeof(mvclpf24), 0, 3, "a", "aaao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf3_aa, NULL, NULL},
    {"mvclpf4", sizeof(mvclpf24_4), 0, 3, "aaaa", "akko",
     (SUBR) mvclpf24_4_init, (SUBR) mvclpf24_perf4, NULL, NULL},
    {"mvclpf4", sizeof(mvclpf24), 0, 3, "aaaa", "aako",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf4_ak, NULL, NULL},
    {"mvclpf4", sizeof(mvclpf24), 0, 3, "aaaa", "akao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf4_ka, NULL, NULL},
    {"mvclpf4", sizeof(mvclpf24), 0, 3, "aaaa", "aaao",
     (SUBR) mvclpf24_init, (SUBR) mvclpf24_perf4_aa, NULL, NULL},
    {"moogladder.kk", sizeof(moogladder), 0, 3, "a", "akko",
     (SUBR) moogladder_init, (SUBR) moogladder_process, NULL, NULL},
    {"moogladder.aa", sizeof(moogladder), 0, 3, "a", "aaao",
     (SUBR) moogladder_init, (SUBR) moogladder_process_aa, NULL, NULL},
    {"moogladder.ak", sizeof(moogladder), 0, 3, "a", "aako",
     (SUBR) moogladder_init, (SUBR) moogladder_process_ak, NULL, NULL},
    {"moogladder.ka", sizeof(moogladder), 0, 3, "a", "akao",
     (SUBR) moogladder_init, (SUBR) moogladder_process_ka, NULL, NULL},
    {"moogladder2.kk", sizeof(moogladder), 0, 3, "a", "akko",
     (SUBR) moogladder_init, (SUBR) moogladder2_process, NULL, NULL},
    {"moogladder2.aa", sizeof(moogladder), 0, 3, "a", "aaao",
     (SUBR) moogladder_init, (SUBR) moogladder2_process_aa, NULL, NULL},
    {"moogladder2.ak", sizeof(moogladder), 0, 3, "a", "aako",
     (SUBR) moogladder_init, (SUBR) moogladder2_process_ak, NULL, NULL},
    {"moogladder2.ka", sizeof(moogladder), 0, 3, "a", "akao",
     (SUBR) moogladder_init, (SUBR) moogladder2_process_ka, NULL, NULL},
    {"statevar", sizeof(statevar), 0, 3, "aaaa", "axxoo",
     (SUBR) statevar_init, (SUBR) statevar_process, NULL, NULL},
    {"fofilter", sizeof(fofilter), 0, 3, "a", "axxxo",
     (SUBR) fofilter_init, (SUBR) fofilter_process, NULL, NULL},
    {"bob", sizeof(BOB), 0, 3, "a", "axxxoo",
     (SUBR) bob_init, (SUBR) bob_process, NULL, NULL},
    {"vps", sizeof(VPS), 0, 2, "a", "akk",
     (SUBR) NULL, (SUBR) vps_process, NULL, NULL},
    {"vclpf", sizeof(VCF), 0, 3, "a", "akko",
     (SUBR) vcf_init, (SUBR) vcf_perfk, NULL, NULL},
    {"vclpf", sizeof(VCF), 0, 3, "a", "aako",
     (SUBR) vcf_init, (SUBR) vcf_perfak, NULL, NULL},
    {"vclpf", sizeof(VCF), 0, 3, "a", "akao",
     (SUBR) vcf_init, (SUBR) vcf_perfka, NULL, NULL},
    {"vclpf", sizeof(VCF), 0, 3, "a", "aaao",
     (SUBR) vcf_init, (SUBR) vcf_perfaa, NULL, NULL},
    {"spf", sizeof(SPF), 0, 3, "a", "aaakko",
     (SUBR) spf_init, (SUBR) spf_perfkk, NULL, NULL},
    {"spf", sizeof(SPF), 0, 3, "a", "aaaako",
     (SUBR) spf_init, (SUBR) spf_perfak, NULL, NULL},
    {"spf", sizeof(SPF), 0, 3, "a", "aaaaao",
     (SUBR) spf_init, (SUBR) spf_perfaa, NULL, NULL},
    {"spf", sizeof(SPF), 0, 3, "a", "aaakao",
     (SUBR) spf_init, (SUBR) spf_perfka, NULL, NULL},
    {"skf", sizeof(SKF), 0, 3, "a", "akkoo",
     (SUBR) skf_init, (SUBR) skf_perfkk, NULL, NULL},
    {"skf", sizeof(SKF), 0, 3, "a", "aakoo",
     (SUBR) skf_init, (SUBR) skf_perfak, NULL, NULL},
    {"skf", sizeof(SKF), 0, 3, "a", "aaaoo",
     (SUBR) skf_init, (SUBR) skf_perfaa, NULL, NULL},
    {"skf", sizeof(SKF), 0, 3, "a", "akaoo",
     (SUBR) skf_init, (SUBR) skf_perfka, NULL, NULL},
    {"svn", sizeof(SVN), 0, 3, "aaaa", "akkkoopo",
     (SUBR) svn_init, (SUBR) svn_perfkk, NULL, NULL},
    {"svn", sizeof(SVN), 0, 3, "aaaa", "aakkoopo",
     (SUBR) svn_init, (SUBR) svn_perfak, NULL, NULL},
    {"svn", sizeof(SVN), 0, 3, "aaaa", "akakoopo",
     (SUBR) svn_init, (SUBR) svn_perfka, NULL, NULL},
    {"svn", sizeof(SVN), 0, 3, "aaaa", "aaakoopo",
     (SUBR) svn_init, (SUBR) svn_perfaa, NULL, NULL},
    {"st2ms", sizeof(MIDSID), 0, 2, "aa", "aa",
     (SUBR) NULL, (SUBR) ms_encod, NULL, NULL},
    {"ms2st", sizeof(MIDSID), 0, 2, "aa", "aak",
     (SUBR) NULL, (SUBR) ms_decod, NULL, NULL},
  };
