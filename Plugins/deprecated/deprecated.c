...
static OENTRY localops[] = { 
  { "stack",  sizeof(STACK_OPCODE), SK|_QQ, 1,  "",   "i",
      (SUBR) stack_opcode_init, (SUBR) NULL,                      (SUBR) NULL, NULL},
  { "push",   sizeof(PUSH_OPCODE),  SK|_QQ, 3,  "",   "N",
      (SUBR) push_opcode_init,  (SUBR) notinit_opcode_stub_perf,  (SUBR) NULL, NULL},
  { "pop",    sizeof(POP_OPCODE),   SK|_QQ, 3,
                                   "NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN", "",
      (SUBR) pop_opcode_init,   (SUBR) notinit_opcode_stub_perf,  (SUBR) NULL, NULL},
  { "push_f", sizeof(PUSH_OPCODE),  SK|_QQ, 3,  "",   "f",
      (SUBR) push_f_opcode_init, (SUBR) notinit_opcode_stub_perf, (SUBR) NULL, NULL},
  { "pop_f",  sizeof(POP_OPCODE),   SK|_QQ, 3,  "f",   "",
      (SUBR) pop_f_opcode_init,  (SUBR) notinit_opcode_stub_perf, (SUBR) NULL, NULL}
};
