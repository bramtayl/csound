...
static int32_t lufs_init(CSOUND *csound, LUFS *p)
{
        ...
        else if (csoundGetSr(csound) == 44100) {
        ...
        p->q = FLOOR(csoundGetSr(csound) * 0.1); // 100 ms grain
...
ADD_INIT_FUNCTION(lufs_localops_init, lufs_localops)
