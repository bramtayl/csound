...
static OENTRY midiout_localops[] = {
    {"mclock", sizeof(MCLOCK), 0, 3, "", "i", (SUBR)mclock_set, (SUBR)mclock,
     NULL, NULL},
    {"mdelay", sizeof(MDELAY), 0, 3, "", "kkkkk", (SUBR)mdelay_set,
     (SUBR)mdelay, NULL, NULL},
    {"midion2", sizeof(KON2), 0, 3, "", "kkkk", (SUBR)kon2_set, (SUBR)kon2,
     NULL, NULL},
    {"midion", sizeof(KOUT_ON), 0, 3, "", "kkk", (SUBR)kvar_out_on_set,
     (SUBR)kvar_out_on, NULL, NULL},
    {"midiout", sizeof(MIDIOUT), 0, 2, "", "kkkk", NULL, (SUBR)midiout, NULL,
     NULL},
    {"midiout_i", sizeof(MIDIOUT), 0, 1, "", "iiii", (SUBR)midiout, NULL, NULL,
     NULL},
    {"moscil", sizeof(MOSCIL), 0, 3, "", "kkkkk", (SUBR)moscil_set,
     (SUBR)moscil, NULL, NULL},
    {"mrtmsg", sizeof(XTRADUR), 0, 1, "", "i", (SUBR)mrtmsg, NULL, NULL, NULL},
    {"noteoff", sizeof(OUT_ON), 0, 1, "", "iii", (SUBR)iout_off, NULL, NULL,
     NULL},
    {"noteon", sizeof(OUT_ON), 0, 1, "", "iii", (SUBR)iout_on, NULL, NULL,
     NULL},
    {"noteondur2", sizeof(OUT_ON_DUR), 0, 3, "", "iiii", (SUBR)iout_on_dur_set,
     (SUBR)iout_on_dur2, NULL, NULL},
    {"noteondur", sizeof(OUT_ON_DUR), 0, 3, "", "iiii", (SUBR)iout_on_dur_set,
     (SUBR)iout_on_dur, NULL, NULL},
    {"nrpn", sizeof(NRPN), 0, 2, "", "kkk", NULL, (SUBR)nrpn, NULL, NULL},
    {"outiat", sizeof(OUT_ATOUCH), 0, 1, "", "iiii", (SUBR)out_aftertouch, NULL,
     NULL, NULL},
    {"outic14", sizeof(OUT_CONTR14), 0, 1, "", "iiiiii", (SUBR)out_controller14,
     NULL, NULL, NULL},
    {"outic", sizeof(OUT_CONTR), 0, 1, "", "iiiii", (SUBR)out_controller, NULL,
     NULL, NULL},
    {"outipat", sizeof(OUT_POLYATOUCH), 0, 1, "", "iiiii",
     (SUBR)out_poly_aftertouch, NULL, NULL, NULL},
    {"outipb", sizeof(OUT_PB), 0, 1, "", "iiii", (SUBR)out_pitch_bend, NULL,
     NULL, NULL},
    {"outipc", sizeof(OUT_PCHG), 0, 1, "", "iiii", (SUBR)out_progchange, NULL,
     NULL, NULL},
    {"outkat", sizeof(OUT_ATOUCH), 0, 2, "", "kkkk", NULL, (SUBR)out_aftertouch,
     NULL, NULL},
    {"outkc14", sizeof(OUT_CONTR14), 0, 2, "", "kkkkkk", NULL,
     (SUBR)out_controller14, NULL, NULL},
    {"outkc", sizeof(OUT_CONTR), 0, 2, "", "kkkkk", NULL, (SUBR)out_controller,
     NULL, NULL},
    {"outkpat", sizeof(OUT_POLYATOUCH), 0, 2, "", "kkkkk", NULL,
     (SUBR)out_poly_aftertouch, NULL, NULL},
    {"outkpb", sizeof(OUT_PB), 0, 2, "", "kkkk", NULL, (SUBR)out_pitch_bend,
     NULL, NULL},
    {"outkpc", sizeof(OUT_PCHG), 0, 2, "", "kkkk", NULL, (SUBR)out_progchange,
     NULL, NULL},
    {"release", sizeof(REL), 0, 3, "k", "", (SUBR)release_set, (SUBR)release,
     NULL, NULL},
    {"xtratim", sizeof(XTRADUR), 0, 1, "", "i", (SUBR)xtratim, NULL, NULL,
     NULL},
};

LINKAGE_BUILTIN(midiout_localops)
