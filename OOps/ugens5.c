...
#include "csoundCore_internal.h"         /*                      UGENS5.C        */
#include "ugens5.h"
#include <math.h>
#include <inttypes.h>
#include "rdscor.h"
...
static OENTRY ugens5_localops[] = {
    {"areson.kk", sizeof(RESON), 0, 3, "a", "akkoo", (SUBR)rsnset, (SUBR)areson,
     NULL, NULL},
    {"aresonk", sizeof(RESON), 0, 3, "k", "kkkpo", (SUBR)rsnset, (SUBR)kareson,
     NULL, NULL},
    {"aresonk", sizeof(RESON), 0, 3, "k", "kkkpo", (SUBR)rsnset, (SUBR)kreson,
     NULL, NULL},
    {"atone.k", sizeof(TONE), 0, 3, "a", "ako", (SUBR)tonset, (SUBR)atone, NULL,
     NULL},
    {"atonek", sizeof(TONE), 0, 3, "k", "kko", (SUBR)tonset, (SUBR)katone, NULL,
     NULL},
    {"atonex.k", sizeof(TONEX), 0, 3, "a", "akoo", (SUBR)tonsetx, (SUBR)atonex,
     NULL, NULL},
    {"balance2", sizeof(BALANCE), 0, 3, "a", "aaqo", (SUBR)balnset,
     (SUBR)balance2, NULL, NULL},
    {"balance", sizeof(BALANCE), 0, 3, "a", "aaqo", (SUBR)balnset,
     (SUBR)balance, NULL, NULL},
    {"gain", sizeof(GAIN), 0, 3, "a", "akqo", (SUBR)gainset, (SUBR)gain, NULL,
     NULL},
    {"limit.a", sizeof(LIMIT), 0, 2, "a", "akk", NULL, (SUBR)limit, NULL, NULL},
    {"limit.i", sizeof(LIMIT), 0, 1, "i", "iii", (SUBR)klimit, NULL, NULL,
     NULL},
    {"limit.k", sizeof(LIMIT), 0, 2, "k", "kkk", NULL, (SUBR)klimit, NULL,
     NULL},
    {"lpform", sizeof(LPFORM), 0, 3, "kk", "k", (SUBR)lpformantset,
     (SUBR)lpformant, NULL, NULL},
    {"lpfreson", sizeof(LPFRESON), 0, 3, "a", "ak", (SUBR)lpfrsnset,
     (SUBR)lpfreson, NULL, NULL},
    {"lpinterp", sizeof(LPINTERPOL), 0, 3, "", "iik", (SUBR)lpitpset,
     (SUBR)lpinterpol, NULL, NULL},
    {"lpread", sizeof(LPREAD), 0, 3, "kkkk", "kSoo", (SUBR)lprdset_S,
     (SUBR)lpread, NULL, NULL},
    {"lpread.i", sizeof(LPREAD), 0, 3, "kkkk", "kioo", (SUBR)lprdset,
     (SUBR)lpread, NULL, NULL},
    {"lpreson", sizeof(LPRESON), 0, 3, "a", "a", (SUBR)lprsnset, (SUBR)lpreson,
     NULL, NULL},
    {"lpslot", sizeof(LPSLOT), 0, 1, "", "i", (SUBR)lpslotset, NULL, NULL,
     NULL},
    {"port", sizeof(PORT), 0, 3, "k", "kio", (SUBR)porset, (SUBR)port, NULL,
     NULL},
    {"portk", sizeof(PORT), 0, 3, "k", "kko", (SUBR)porset, (SUBR)kport, NULL,
     NULL},
    {"reson", sizeof(RESON), 0, 3, "a", "axxoo", (SUBR)rsnset, (SUBR)reson,
     NULL, NULL},
    {"resonk", sizeof(RESON), 0, 3, "k", "kkkpo", (SUBR)rsnset, (SUBR)kreson,
     NULL, NULL},
    {"resonx", sizeof(RESONX), 0, 3, "a", "axxooo", (SUBR)rsnsetx, (SUBR)resonx,
     NULL, NULL},
    {"rms", sizeof(RMS), 0, 3, "k", "aqo", (SUBR)rmsset, (SUBR)rms, NULL, NULL},
    {"tone.k", sizeof(TONE), 0, 3, "a", "ako", (SUBR)tonset, (SUBR)tone, NULL,
     NULL},
    {"tonek", sizeof(TONE), 0, 3, "k", "kko", (SUBR)tonset, (SUBR)ktone, NULL,
     NULL},
    {"tonex.k", sizeof(TONEX), 0, 3, "a", "akoo", (SUBR)tonsetx, (SUBR)tonex,
     NULL, NULL},
};

LINKAGE_BUILTIN(ugens5_localops)