...
static OENTRY ugens2_localops[] = {
    {"ephasor", sizeof(EPHSOR), 0, 3, "aa", "xko", (SUBR)ephsset, (SUBR)ephsor,
     NULL, NULL},
    {"oscil1", sizeof(OSCIL1), TR, 3, "k", "ikij", (SUBR)ko1set, (SUBR)kosc1,
     NULL, NULL},
    {"oscil1i", sizeof(OSCIL1), TR, 3, "k", "ikij", (SUBR)ko1set, (SUBR)kosc1i,
     NULL, NULL},
    {"oscil3.a", sizeof(OSC), TR, 3, "a", "kkjo", (SUBR)oscset, (SUBR)osckk3,
     NULL, NULL},
    {"oscil3.aA", sizeof(OSC), 0, 3, "a", "kki[]o", (SUBR)oscsetA, (SUBR)osckk3,
     NULL, NULL},
    {"oscil3.aa", sizeof(OSC), TR, 3, "a", "aajo", (SUBR)oscset,
     (SUBR)(SUBR)oscaa3, NULL, NULL},
    {"oscil3.aaA", sizeof(OSC), 0, 3, "a", "aai[]o", (SUBR)oscsetA,
     (SUBR)oscaa3, NULL, NULL},
    {"oscil3.ak", sizeof(OSC), TR, 3, "a", "akjo", (SUBR)oscset, (SUBR)oscak3,
     NULL, NULL},
    {"oscil3.akA", sizeof(OSC), 0, 3, "a", "aki[]o", (SUBR)oscsetA,
     (SUBR)oscak3, NULL, NULL},
    {"oscil3.ka", sizeof(OSC), TR, 3, "a", "kajo", (SUBR)oscset, (SUBR)oscka3,
     NULL, NULL},
    {"oscil3.kaA", sizeof(OSC), 0, 3, "a", "kai[]o", (SUBR)oscsetA,
     (SUBR)oscka3, NULL, NULL},
    {"oscil3.kk", sizeof(OSC), TR, 3, "k", "kkjo", (SUBR)oscset, (SUBR)koscl3,
     NULL, NULL},
    {"oscil3.kkA", sizeof(OSC), 0, 3, "k", "kki[]o", (SUBR)oscsetA,
     (SUBR)koscl3, NULL, NULL},
    {"oscil.a", sizeof(OSC), TR, 3, "a", "kkjo", (SUBR)oscset, (SUBR)osckk,
     NULL, NULL},
    {"oscil.aa", sizeof(OSC), TR, 3, "a", "aajo", (SUBR)oscset, (SUBR)oscaa,
     NULL, NULL},
    {"oscil.aaA", sizeof(OSC), 0, 3, "a", "aai[]o", (SUBR)oscsetA, (SUBR)oscaa,
     NULL, NULL},
    {"oscil.ak", sizeof(OSC), TR, 3, "a", "akjo", (SUBR)oscset, (SUBR)oscak,
     NULL, NULL},
    {"oscil.akA", sizeof(OSC), 0, 3, "a", "aki[]o", (SUBR)oscsetA, (SUBR)oscak,
     NULL, NULL},
    {"oscil.ka", sizeof(OSC), TR, 3, "a", "kajo", (SUBR)oscset, (SUBR)oscka,
     NULL, NULL},
    {"oscil.kaA", sizeof(OSC), 0, 3, "a", "kai[]o", (SUBR)oscsetA, (SUBR)oscka,
     NULL, NULL},
    {"oscil.kkA", sizeof(OSC), 0, 3, "a", "kki[]o", (SUBR)oscsetA, (SUBR)osckk,
     NULL, NULL},
    {"oscil.kkA", sizeof(OSC), 0, 3, "k", "kki[]o", (SUBR)oscsetA, (SUBR)koscil,
     NULL, NULL},
    {"oscil.kka", sizeof(OSC), TR, 3, "a", "kkjo", (SUBR)oscset, (SUBR)osckk,
     NULL, NULL},
    {"oscil.kkk", sizeof(OSC), TR, 3, "k", "kkjo", (SUBR)oscset, (SUBR)koscil,
     NULL, NULL},
    {"oscili.a", sizeof(OSC), TR, 3, "a", "kkjo", (SUBR)oscset, (SUBR)osckki,
     NULL, NULL},
    {"oscili.aA", sizeof(OSC), 0, 3, "a", "kki[]o", (SUBR)oscsetA, (SUBR)osckki,
     NULL, NULL},
    {"oscili.aa", sizeof(OSC), TR, 3, "a", "aajo", (SUBR)oscset, (SUBR)oscaai,
     NULL, NULL},
    {"oscili.aaA", sizeof(OSC), 0, 3, "a", "aai[]o", (SUBR)oscsetA,
     (SUBR)oscaai, NULL, NULL},
    {"oscili.ak", sizeof(OSC), TR, 3, "a", "akjo", (SUBR)oscset, (SUBR)oscaki,
     NULL, NULL},
    {"oscili.akA", sizeof(OSC), 0, 3, "a", "aki[]o", (SUBR)oscsetA,
     (SUBR)oscaki, NULL, NULL},
    {"oscili.ka", sizeof(OSC), TR, 3, "a", "kajo", (SUBR)oscset, (SUBR)osckai,
     NULL, NULL},
    {"oscili.kaA", sizeof(OSC), 0, 3, "a", "kai[]o", (SUBR)oscsetA,
     (SUBR)osckai, NULL, NULL},
    {"oscili.kk", sizeof(OSC), TR, 3, "k", "kkjo", (SUBR)oscset, (SUBR)koscli,
     NULL, NULL},
    {"oscili.kkA", sizeof(OSC), 0, 3, "k", "kki[]o", (SUBR)oscsetA,
     (SUBR)koscli, NULL, NULL},
    {"osciln", sizeof(OSCILN), TR, 3, "a", "kiii", (SUBR)oscnset, (SUBR)osciln,
     NULL, NULL},
    {"oscilx", sizeof(OSCILN), TR, 3, "a", "kiii", (SUBR)oscnset, (SUBR)osciln,
     NULL, NULL},
    {"phasor", sizeof(PHSOR), 0, 3, "a", "xo", (SUBR)phsset, (SUBR)phsor, NULL,
     NULL},
    {"phasor.k", sizeof(PHSOR), 0, 3, "k", "ko", (SUBR)phsset, (SUBR)kphsor,
     NULL, NULL},
};

LINKAGE_BUILTIN(ugens2_localops)