...
{ "wrap",   0xffff, 0, 0, "", "", NULL, NULL, NULL, NULL},
{ "wrap.i", S(WRAP),     0,1,  "i", "iii",  (SUBR)kwrap, NULL,    NULL, NULL},
{ "wrap.k", S(WRAP),     0,2,  "k", "kkk",  NULL,  (SUBR)kwrap,   NULL, NULL},
{ "wrap.a", S(WRAP),     0,2,  "a", "akk",  NULL,          (SUBR)wrap, NULL, NULL},
{ "mirror", 0xffff, 0, 0, "", "", NULL, NULL, NULL, NULL},
{ "mirror.i", S(WRAP),   0,1,  "i", "iii",  (SUBR)kmirror, NULL,  NULL, NULL},
{ "mirror.k", S(WRAP),   0,2,  "k", "kkk",  NULL,  (SUBR)kmirror, NULL, NULL},
{ "mirror.a", S(WRAP),   0,2,  "a", "akk",  NULL,         (SUBR)mirror, NULL, NULL},
{ "ntrpol.i",S(INTERPOL), 0,1, "i", "iiiop",(SUBR)interpol, NULL, NULL, NULL},
{ "ntrpol.k",S(INTERPOL), 0,3, "k", "kkkop",(SUBR)nterpol_init, (SUBR)knterpol, NULL, NULL},
{ "ntrpol.a",S(INTERPOL), 0,3, "a", "aakop",(SUBR)nterpol_init,(SUBR)anterpol, NULL, NULL},
{ "fold",    S(FOLD),     0,3, "a", "ak",   (SUBR)fold_set, (SUBR)fold, NULL, NULL},
{ "lineto",   S(LINETO),  0,3, "k", "kk",   (SUBR)lineto_set,  (SUBR)lineto, NULL, NULL},
{ "tlineto",  S(LINETO2), 0,3, "k", "kkk",  (SUBR)tlineto_set, (SUBR)tlineto, NULL, NULL},
{ "vibrato",  S(VIBRATO), TR, 3, "k", "kkkkkkkkio",
                                        (SUBR)vibrato_set, (SUBR)vibrato, NULL, NULL},
{ "vibr",     S(VIBRATO), TR, 3, "k", "kki",  (SUBR)vibr_set, (SUBR)vibr, NULL, NULL},
{ "jitter2",  S(JITTER2), 0,3, "k", "kkkkkkko", (SUBR)jitter2_set, (SUBR)jitter2, NULL, NULL},
{ "jitter",   S(JITTER),  0,3, "k", "kkk",  (SUBR)jitter_set, (SUBR)jitter, NULL, NULL},
{ "jspline",  S(JITTERS), 0,3, "k", "xkk",
                                (SUBR)jitters_set, (SUBR)jitters, NULL, NULL},
{ "jspline.a",  S(JITTERS), 0,3, "a", "xkk",
    (SUBR)jitters_set, (SUBR)jittersa, NULL, NULL},
{ "loopseg",  S(LOOPSEG), 0,3, "k", "kkiz", (SUBR)loopseg_set, (SUBR)loopseg, NULL, NULL},
{ "loopxseg", S(LOOPSEG), 0,3, "k", "kkiz", (SUBR)loopseg_set,(SUBR)loopxseg, NULL, NULL},
{ "looptseg", S(LOOPSEG), 0,3, "k", "kkiz",(SUBR)looptseg_set,(SUBR)looptseg, NULL, NULL},
{ "lpshold",  S(LOOPSEG), 0,3, "k", "kkiz",(SUBR)loopseg_set, (SUBR)lpshold, NULL, NULL},
{ "loopsegp", S(LOOPSEGP), 0,3,"k", "kz",  (SUBR)loopsegp_set,(SUBR)loopsegp, NULL, NULL},
{ "lpsholdp", S(LOOPSEGP), 0,3,"k", "kz",  (SUBR)loopsegp_set,(SUBR)lpsholdp, NULL, NULL},
{ "cuserrnd.i", S(CURAND),0,1,"i",  "iii",  (SUBR)iContinuousUserRand, NULL, NULL, NULL},
{ "cuserrnd.k", S(CURAND),0,2,"k",  "kkk",
                            (SUBR)Cuserrnd_set, (SUBR)kContinuousUserRand, NULL, NULL},
{ "cuserrnd.a",S(CURAND),0,2, "a", "kkk",
                            (SUBR)Cuserrnd_set, (SUBR)aContinuousUserRand, NULL, NULL},
{ "random.i", S(RANGERAND), 0,1, "i", "ii",    (SUBR)ikRangeRand, NULL, NULL, NULL},
{ "random.k", S(RANGERAND), 0,2, "k", "kk",    NULL, (SUBR)ikRangeRand, NULL, NULL},
{ "random.a", S(RANGERAND), 0,2, "a", "kk",    NULL,  (SUBR)aRangeRand, NULL, NULL},
{ "rspline",  S(RANDOM3), 0,3, "k", "xxkk",
                               (SUBR)random3_set, (SUBR)random3, NULL, NULL},
{ "rspline.a",  S(RANDOM3), 0,3, "a", "xxkk",
                               (SUBR)random3_set, (SUBR)random3a, NULL, NULL},
{ "randomi",  S(RANDOMI), 0,3, "a", "kkxoo",
                               (SUBR)randomi_set, (SUBR)randomi, NULL, NULL},
{ "randomi.k",  S(RANDOMI), 0,3, "k", "kkkoo",
                               (SUBR)randomi_set, (SUBR)krandomi,NULL, NULL},
{ "randomh",  S(RANDOMH), 0,3, "a", "kkxoo",
                                 (SUBR)randomh_set,(SUBR)randomh, NULL, NULL},
{ "randomh.k",  S(RANDOMH), 0,3, "k", "kkkoo",
                                 (SUBR)randomh_set,(SUBR)krandomh,NULL, NULL},
{ "urd.i",  S(DURAND),  0,1, "i", "i", (SUBR)iDiscreteUserRand, NULL, NULL, NULL},
{ "urd.k",  S(DURAND),  0,2, "k", "k", (SUBR)Cuserrnd_set,(SUBR)kDiscreteUserRand, NULL, NULL},
{ "urd.a",  S(DURAND),  0,2, "a", "k",
                              (SUBR)Cuserrnd_set, (SUBR)aDiscreteUserRand, NULL, NULL},
{ "duserrnd.i", S(DURAND),0,1, "i", "i",  (SUBR)iDiscreteUserRand, NULL, NULL, NULL},
{ "duserrnd.k", S(DURAND),0,2, "k", "k",
                                (SUBR)Cuserrnd_set,(SUBR)kDiscreteUserRand,NULL, NULL},
{ "duserrnd.a", S(DURAND),0,2, "a", "k",
                                (SUBR)Cuserrnd_set,(SUBR)aDiscreteUserRand, NULL, NULL},
//{ "poscil", 0xfffe, TR                                                          },
{ "poscil.a", S(POSC), TR,3, "a", "kkjo", (SUBR)posc_set,(SUBR)posckk, NULL, NULL},
{ "poscil.kk", S(POSC), TR,3, "k", "kkjo", (SUBR)posc_set,(SUBR)kposc,NULL, NULL},
{ "poscil.ka", S(POSC), TR,3, "a", "kajo", (SUBR)posc_set,  (SUBR)poscka, NULL, NULL},
{ "poscil.ak", S(POSC), TR,3, "a", "akjo", (SUBR)posc_set,  (SUBR)poscak, NULL, NULL},
{ "poscil.aa", S(POSC), TR,3, "a", "aajo", (SUBR)posc_set,  (SUBR)poscaa, NULL, NULL},
{ "lposcil",  S(LPOSC), TR, 3, "a", "kkkkjo", (SUBR)lposc_set, (SUBR)lposc, NULL, NULL},
//{ "poscil3", 0xfffe, TR                                                     },
{ "poscil3.a",S(POSC), TR,3, "a", "kkjo",
                                     (SUBR)posc_set,(SUBR)posc3kk, NULL, NULL},
{ "poscil3.kk",S(POSC), TR,3, "k", "kkjo",
                                     (SUBR)posc_set,(SUBR)kposc3,NULL, NULL},
{ "poscil3.ak", S(POSC), TR,3, "a", "akjo", (SUBR)posc_set, (SUBR)posc3ak, NULL, NULL},
{ "poscil3.ka", S(POSC), TR,3, "a", "kajo", (SUBR)posc_set, (SUBR)posc3ka, NULL, NULL},
{ "poscil3.aa", S(POSC), TR,3, "a", "aajo", (SUBR)posc_set, (SUBR)posc3aa, NULL, NULL},
{ "lposcil3", S(LPOSC), TR, 3, "a", "kkkkjo", (SUBR)lposc_set,(SUBR)lposc3, NULL, NULL},
{ "trigger",  S(TRIG),  0,3, "k", "kkk",  (SUBR)trig_set, (SUBR)trig,   NULL, NULL},
{ "sum",      S(SUM),   0,3, "a", "y",    (SUBR)sum_init, (SUBR)sum_, NULL, NULL},
{ "product",  S(SUM),   0,2, "a", "y",    NULL, (SUBR)product, NULL, NULL},
{ "resony",  S(RESONY), 0,3, "a", "akkikooo", (SUBR)rsnsety, (SUBR)resony, NULL, NULL}
};
