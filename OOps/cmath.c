...
static OENTRY cmath_localops[] = {
    {"##pow.a", sizeof(POW), 0, 2, "a", "akp", NULL, (SUBR)apow, NULL, NULL},
    {"##pow.i", sizeof(POW), 0, 1, "i", "iip", (SUBR)ipow, NULL, NULL, NULL},
    {"##pow.k", sizeof(POW), 0, 2, "k", "kkp", NULL, (SUBR)ipow, NULL, NULL},
    {"betarand.a", sizeof(PRAND), 0, 2, "a", "kkk", NULL, (SUBR)abeta, NULL,
     NULL},
    {"betarand.i", sizeof(PRAND), 0, 1, "i", "kkk", (SUBR)ikbeta, NULL, NULL,
     NULL},
    {"betarand.k", sizeof(PRAND), 0, 2, "k", "kkk", NULL, (SUBR)ikbeta, NULL,
     NULL},
    {"bexprnd.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)abiexp, NULL,
     NULL},
    {"bexprnd.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikbiexp, NULL, NULL,
     NULL},
    {"bexprnd.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikbiexp, NULL,
     NULL},
    {"cauchy.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)acauchy, NULL,
     NULL},
    {"cauchy.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikcauchy, NULL, NULL,
     NULL},
    {"cauchy.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikcauchy, NULL,
     NULL},
    {"cauchyi.a", sizeof(PRANDI), 0, 2, "a", "kxx", (SUBR)cauchyiset,
     (SUBR)acauchyi, NULL, NULL},
    {"cauchyi.i", sizeof(PRANDI), 0, 1, "i", "kxx", (SUBR)icauchyi, NULL, NULL,
     NULL},
    {"cauchyi.k", sizeof(PRANDI), 0, 3, "k", "kxx", (SUBR)cauchyiset,
     (SUBR)kcauchyi, NULL, NULL},
    {"exprand.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)aexp, NULL, NULL},
    {"exprand.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikexp, NULL, NULL, NULL},
    {"exprand.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikexp, NULL, NULL},
    {"exprandi.a", sizeof(PRANDI), 0, 2, "a", "kxx", (SUBR)exprndiset,
     (SUBR)aexprndi, NULL, NULL},
    {"exprandi.i", sizeof(PRANDI), 0, 1, "i", "kxx", (SUBR)iexprndi, NULL, NULL,
     NULL},
    {"exprandi.k", sizeof(PRANDI), 0, 3, "k", "kxx", (SUBR)exprndiset,
     (SUBR)kexprndi, NULL, NULL},
    {"gauss.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)agaus, NULL, NULL},
    {"gauss.akk", sizeof(GAUSS), 0, 2, "a", "kk", NULL, (SUBR)gauss_vector,
     NULL, NULL},
    {"gauss.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikgaus, NULL, NULL, NULL},
    {"gauss.iii", sizeof(GAUSS), 0, 1, "i", "ii", (SUBR)gauss_scalar, NULL,
     NULL, NULL},
    {"gauss.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikgaus, NULL, NULL},
    {"gauss.kkk", sizeof(GAUSS), 0, 2, "k", "kk", NULL, (SUBR)gauss_scalar,
     NULL, NULL},
    {"gaussi.a", sizeof(PRANDI), 0, 2, "a", "kxx", (SUBR)gaussiset,
     (SUBR)agaussi, NULL, NULL},
    {"gaussi.i", sizeof(PRANDI), 0, 1, "i", "kxx", (SUBR)igaussi, NULL, NULL,
     NULL},
    {"gaussi.k", sizeof(PRANDI), 0, 3, "k", "kxx", (SUBR)gaussiset,
     (SUBR)kgaussi, NULL, NULL},
    {"getseed.i", sizeof(GETSEED), 0, 1, "i", "", (SUBR)getseed, NULL, NULL,
     NULL},
    {"getseed.k", sizeof(GETSEED), 0, 3, "k", "", (SUBR)getseed, (SUBR)getseed,
     NULL, NULL},
    {"linrand.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)alinear, NULL,
     NULL},
    {"linrand.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)iklinear, NULL, NULL,
     NULL},
    {"linrand.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)iklinear, NULL,
     NULL},
    {"pcauchy.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)apcauchy, NULL,
     NULL},
    {"pcauchy.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikpcauchy, NULL, NULL,
     NULL},
    {"pcauchy.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikpcauchy, NULL,
     NULL},
    {"poisson.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)apoiss, NULL,
     NULL},
    {"poisson.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikpoiss, NULL, NULL,
     NULL},
    {"poisson.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikpoiss, NULL,
     NULL},
    {"pow.a", sizeof(POW), 0, 2, "a", "akp", NULL, (SUBR)apow, NULL, NULL},
    {"pow.i", sizeof(POW), 0, 1, "i", "iip", (SUBR)ipow, NULL, NULL, NULL},
    {"pow.k", sizeof(POW), 0, 2, "k", "kkp", NULL, (SUBR)ipow, NULL, NULL},
    {"seed", sizeof(PRAND), 0, 1, "", "i", (SUBR)seedrand, NULL, NULL, NULL},
    {"trirand.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)atrian, NULL,
     NULL},
    {"trirand.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)iktrian, NULL, NULL,
     NULL},
    {"trirand.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)iktrian, NULL,
     NULL},
    {"unirand.a", sizeof(PRAND), 0, 2, "a", "k", NULL, (SUBR)auniform, NULL,
     NULL},
    {"unirand.i", sizeof(PRAND), 0, 1, "i", "k", (SUBR)ikuniform, NULL, NULL,
     NULL},
    {"unirand.k", sizeof(PRAND), 0, 2, "k", "k", NULL, (SUBR)ikuniform, NULL,
     NULL},
    {"weibull.a", sizeof(PRAND), 0, 2, "a", "kk", NULL, (SUBR)aweib, NULL,
     NULL},
    {"weibull.i", sizeof(PRAND), 0, 1, "i", "kk", (SUBR)ikweib, NULL, NULL,
     NULL},
    {"weibull.k", sizeof(PRAND), 0, 2, "k", "kk", NULL, (SUBR)ikweib, NULL,
     NULL},
};

LINKAGE_BUILTIN(cmath_localops)
