...
static OENTRY localops[] = {
  { "biquad", S(BIQUAD),   0, 3, "a", "akkkkkko",
                                 (SUBR)biquadset,  (SUBR)biquad, NULL, NULL},
{ "biquada", S(BIQUAD),  0, 3, "a", "aaaaaaao",
                                 (SUBR)biquadset, (SUBR)biquada, NULL, NULL},
{ "moogvcf", S(MOOGVCF), 0, 3, "a", "axxpo",
                               (SUBR)moogvcfset,  (SUBR)moogvcf, NULL, NULL},
{ "moogvcf2", S(MOOGVCF),0, 3, "a", "axxoo",
                               (SUBR)moogvcfset,  (SUBR)moogvcf, NULL, NULL},
{ "rezzy", S(REZZY),     0, 3, "a", "axxoo", (SUBR)rezzyset,  (SUBR)rezzy, NULL, NULL},
{ "bqrez", S(REZZY),     0, 3, "a", "axxoo", (SUBR)bqrezset,  (SUBR)bqrez, NULL, NULL},
{ "distort1", S(DISTORT),TR, 2, "a", "akkkko",  NULL,      (SUBR)distort, NULL, NULL},
{ "vco", S(VCO),      TR, 3, "a", "xxiVppovoo",(SUBR)vcoset,  (SUBR)vco, NULL, NULL},
{ "tbvcf", S(TBVCF),     0, 3, "a", "axxkkp",
                                 (SUBR)tbvcfset,  (SUBR)tbvcf, NULL, NULL},
{ "planet", S(PLANET),0, 3,"aaa","kkkiiiiiiioo",
                                  (SUBR)planetset,  (SUBR)planet, NULL, NULL},
{ "pareq", S(PAREQ),     0, 3, "a", "akkkoo",(SUBR)pareqset,  (SUBR)pareq, NULL, NULL},
{ "nestedap", S(NESTEDAP),0, 3,"a", "aiiiiooooo",
                                     (SUBR)nestedapset,  (SUBR)nestedap, NULL, NULL},
{ "lorenz", S(LORENZ),0,  3, "aaa", "kkkkiiiio",
                                  (SUBR)lorenzset,  (SUBR)lorenz, NULL, NULL},
{ "mode",  S(MODE),   0, 3,      "a", "axxo", (SUBR)modeset,  (SUBR)mode, NULL, NULL},
{ "mvmfilter", S(MVMFILT), 0, 3, "a", "axxo",
                                  (SUBR) mvmfilterset, (SUBR) mvmfilter, NULL, NULL},
};
