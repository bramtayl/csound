...
static OENTRY ugens1_localops[] = {
    {"adsr", sizeof(LINSEG), 0, 3, "k", "iiiio", (SUBR)adsrset, (SUBR)klnseg,
     NULL, NULL},
    {"adsr.a", sizeof(LINSEG), 0, 3, "a", "iiiio", (SUBR)adsrset, (SUBR)linseg,
     NULL, NULL},
    {"cosseg", sizeof(COSSEG), 0, 3, "k", "iim", (SUBR)csgset, (SUBR)kosseg,
     NULL, NULL},
    {"cosseg.a", sizeof(COSSEG), 0, 3, "a", "iim", (SUBR)csgset, (SUBR)cosseg,
     NULL, NULL},
    {"cossegb", sizeof(COSSEG), 0, 3, "k", "iim", (SUBR)csgset_bkpt,
     (SUBR)kosseg, NULL, NULL},
    {"cossegb.a", sizeof(COSSEG), 0, 3, "a", "iim", (SUBR)csgset_bkpt,
     (SUBR)cosseg, NULL, NULL},
    {"cossegr", sizeof(COSSEG), 0, 3, "k", "iim", (SUBR)csgrset, (SUBR)kcssegr,
     NULL, NULL},
    {"cossegr.a", sizeof(COSSEG), 0, 3, "a", "iim", (SUBR)csgrset,
     (SUBR)cossegr, NULL, NULL},
    {"envlpx", sizeof(ENVLPX), TR, 3, "k", "kiiiiiio", (SUBR)evxset,
     (SUBR)knvlpx, NULL, NULL},
    {"envlpx.a", sizeof(ENVLPX), TR, 3, "a", "aiiiiiio", (SUBR)aevxset,
     (SUBR)envlpx, NULL, NULL},
    {"envlpx.x", sizeof(ENVLPX), TR, 3, "a", "kiiiiiio", (SUBR)aevxset,
     (SUBR)envlpx, NULL, NULL},
    {"envlpxr", sizeof(ENVLPR), TR, 3, "k", "kiiiiioo", (SUBR)evrset,
     (SUBR)knvlpxr, NULL, NULL},
    {"envlpxr.a", sizeof(ENVLPR), TR, 3, "a", "aiiiiioo", (SUBR)aevrset,
     (SUBR)envlpxr, NULL, NULL},
    {"envlpxr.x", sizeof(ENVLPR), TR, 3, "a", "kiiiiioo", (SUBR)aevrset,
     (SUBR)envlpxr, NULL, NULL},
    {"expon", sizeof(EXPON), 0, 3, "k", "iii", (SUBR)expset, (SUBR)kexpon, NULL,
     NULL},
    {"expon.a", sizeof(EXPON), 0, 3, "a", "iii", (SUBR)expset, (SUBR)expon,
     NULL, NULL},
    {"expseg", sizeof(EXXPSEG), 0, 3, "k", "iim", (SUBR)xsgset, (SUBR)kxpseg,
     NULL, NULL},
    {"expseg.a", sizeof(EXXPSEG), 0, 3, "a", "iim", (SUBR)xsgset, (SUBR)expseg,
     NULL, NULL},
    {"expsega", sizeof(EXPSEG2), 0, 3, "a", "iim", (SUBR)xsgset2, (SUBR)expseg2,
     NULL, NULL},
    {"expsegb", sizeof(EXXPSEG), 0, 3, "k", "iim", (SUBR)xsgset_bkpt,
     (SUBR)kxpseg, NULL, NULL},
    {"expsegb.a", sizeof(EXXPSEG), 0, 3, "a", "iim", (SUBR)xsgset_bkpt,
     (SUBR)expseg, NULL, NULL},
    {"expsegba", sizeof(EXPSEG2), 0, 3, "a", "iim", (SUBR)xsgset2b,
     (SUBR)expseg2, NULL, NULL},
    {"expsegr", sizeof(EXPSEG), 0, 3, "k", "iim", (SUBR)xsgrset, (SUBR)kxpsegr,
     NULL, NULL},
    {"expsegr.a", sizeof(EXPSEG), 0, 3, "a", "iim", (SUBR)xsgrset,
     (SUBR)expsegr, NULL, NULL},
    {"line", sizeof(LINE), 0, 3, "k", "iii", (SUBR)linset, (SUBR)kline, NULL,
     NULL},
    {"line.a", sizeof(LINE), 0, 3, "a", "iii", (SUBR)linset, (SUBR)aline, NULL,
     NULL},
    {"linen", sizeof(LINEN), 0, 3, "k", "kiii", (SUBR)lnnset, (SUBR)klinen,
     NULL, NULL},
    {"linen.a", sizeof(LINEN), 0, 3, "a", "aiii", (SUBR)alnnset, (SUBR)linen,
     NULL, NULL},
    {"linen.x", sizeof(LINEN), 0, 3, "a", "kiii", (SUBR)alnnset, (SUBR)linen,
     NULL, NULL},
    {"linenr", sizeof(LINENR), 0, 3, "k", "kiii", (SUBR)lnrset, (SUBR)klinenr,
     NULL, NULL},
    {"linenr.a", sizeof(LINENR), 0, 3, "a", "aiii", (SUBR)alnrset, (SUBR)linenr,
     NULL, NULL},
    {"linenr.x", sizeof(LINENR), 0, 3, "a", "kiii", (SUBR)alnrset, (SUBR)linenr,
     NULL, NULL},
    {"linseg", sizeof(LINSEG), 0, 3, "k", "iim", (SUBR)lsgset, (SUBR)klnseg,
     NULL, NULL},
    {"linseg.a", sizeof(LINSEG), 0, 3, "a", "iim", (SUBR)lsgset, (SUBR)linseg,
     NULL, NULL},
    {"linsegb", sizeof(LINSEG), 0, 3, "k", "iim", (SUBR)lsgset_bkpt,
     (SUBR)klnseg, NULL, NULL},
    {"linsegb.a", sizeof(LINSEG), 0, 3, "a", "iim", (SUBR)lsgset_bkpt,
     (SUBR)linseg, NULL, NULL},
    {"linsegr", sizeof(LINSEG), 0, 3, "k", "iim", (SUBR)lsgrset, (SUBR)klnsegr,
     NULL, NULL},
    {"linsegr.a", sizeof(LINSEG), 0, 3, "a", "iim", (SUBR)lsgrset,
     (SUBR)linsegr, NULL, NULL},
    {"madsr", sizeof(LINSEG), 0, 3, "k", "iiiioj", (SUBR)madsrset,
     (SUBR)klnsegr, NULL, NULL},
    {"madsr.a", sizeof(LINSEG), 0, 3, "a", "iiiioj", (SUBR)madsrset,
     (SUBR)linsegr, NULL, NULL},
    {"mxadsr", sizeof(EXPSEG), 0, 3, "k", "iiiioj", (SUBR)mxdsrset,
     (SUBR)kxpsegr, NULL, NULL},
    {"mxadsr.a", sizeof(EXPSEG), 0, 3, "a", "iiiioj", (SUBR)mxdsrset,
     (SUBR)expsegr, NULL, NULL},
    {"xadsr", sizeof(EXXPSEG), 0, 3, "k", "iiiio", (SUBR)xdsrset, (SUBR)kxpseg,
     NULL, NULL},
    {"xadsr.a", sizeof(EXXPSEG), 0, 3, "a", "iiiio", (SUBR)xdsrset,
     (SUBR)expseg, NULL, NULL},
};

LINKAGE_BUILTIN(ugens1_localops)