...
static OENTRY aops_localops[] = {
    {"!", sizeof(LOGCL), 0, 0, "b", "b", (SUBR)b_not, (SUBR)b_not, NULL, NULL},
    {"!.0", sizeof(LOGCL), 0, 0, "B", "B", (SUBR)b_not, (SUBR)b_not, NULL,
     NULL},
    {"!=", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)ne, (SUBR)ne, NULL, NULL},
    {"!=.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)ne, (SUBR)ne, NULL, NULL},
    {"##add.aa", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)addaa, NULL, NULL},
    {"##add.ak", sizeof(AOP), 0, 2, "a", "ak", NULL, (SUBR)addak, NULL, NULL},
    {"##add.ii", sizeof(AOP), 0, 1, "i", "ii", (SUBR)addkk, NULL, NULL, NULL},
    {"##add.ka", sizeof(AOP), 0, 2, "a", "ka", NULL, (SUBR)addka, NULL, NULL},
    {"##add.kk", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)addkk, NULL, NULL},
    {"##addin.a", sizeof(ASSIGN), 0, 2, "a", "a", NULL, (SUBR)addina, NULL,
     NULL},
    {"##addin.i", sizeof(ASSIGN), 0, 1, "i", "i", (SUBR)addin, NULL, NULL,
     NULL},
    {"##addin.K", sizeof(ASSIGN), 0, 2, "a", "k", NULL, (SUBR)addinak, NULL,
     NULL},
    {"##addin.k", sizeof(ASSIGN), 0, 2, "k", "k", NULL, (SUBR)addin, NULL,
     NULL},
    {"##div.aa", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)divaa, NULL, NULL},
    {"##div.ak", sizeof(AOP), 0, 2, "a", "ak", NULL, (SUBR)divak, NULL, NULL},
    {"##div.ii", sizeof(AOP), 0, 1, "i", "ii", (SUBR)divkk, NULL, NULL, NULL},
    {"##div.ka", sizeof(AOP), 0, 2, "a", "ka", NULL, (SUBR)divka, NULL, NULL},
    {"##div.kk", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)divkk, NULL, NULL},
    {"##error", sizeof(ERRFN), 0, 1, "i", "i", (SUBR)error_fn, NULL, NULL,
     NULL},
    {"##mod.aa", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)modaa, NULL, NULL},
    {"##mod.ak", sizeof(AOP), 0, 2, "a", "ak", NULL, (SUBR)modak, NULL, NULL},
    {"##mod.ii", sizeof(AOP), 0, 1, "i", "ii", (SUBR)modkk, NULL, NULL, NULL},
    {"##mod.ka", sizeof(AOP), 0, 2, "a", "ka", NULL, (SUBR)modka, NULL, NULL},
    {"##mod.kk", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)modkk, NULL, NULL},
    {"##mul.aa", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)mulaa, NULL, NULL},
    {"##mul.ak", sizeof(AOP), 0, 2, "a", "ak", NULL, (SUBR)mulak, NULL, NULL},
    {"##mul.ii", sizeof(AOP), 0, 1, "i", "ii", (SUBR)mulkk, NULL, NULL, NULL},
    {"##mul.ka", sizeof(AOP), 0, 2, "a", "ka", NULL, (SUBR)mulka, NULL, NULL},
    {"##mul.kk", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)mulkk, NULL, NULL},
    {"##sub.aa", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)subaa, NULL, NULL},
    {"##sub.ak", sizeof(AOP), 0, 2, "a", "ak", NULL, (SUBR)subak, NULL, NULL},
    {"##sub.ii", sizeof(AOP), 0, 1, "i", "ii", (SUBR)subkk, NULL, NULL, NULL},
    {"##sub.ka", sizeof(AOP), 0, 2, "a", "ka", NULL, (SUBR)subka, NULL, NULL},
    {"##sub.kk", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)subkk, NULL, NULL},
    {"##subin.a", sizeof(ASSIGN), 0, 2, "a", "a", NULL, (SUBR)subina, NULL,
     NULL},
    {"##subin.i", sizeof(ASSIGN), 0, 1, "i", "i", (SUBR)subin, NULL, NULL,
     NULL},
    {"##subin.K", sizeof(ASSIGN), 0, 2, "a", "k", NULL, (SUBR)subinak, NULL},
    {"##subin.k", sizeof(ASSIGN), 0, 2, "k", "k", NULL, (SUBR)subin, NULL,
     NULL},
    {"&&", sizeof(LOGCL), 0, 0, "b", "bb", (SUBR) and, (SUBR) and, NULL, NULL},
    {"&&.0", sizeof(LOGCL), 0, 0, "B", "BB", (SUBR) and, (SUBR) and, NULL,
     NULL},
    {":cond.a", sizeof(CONVAL), 0, 2, "a", "Bxx", NULL, (SUBR)aconval, NULL,
     NULL},
    {":cond.i", sizeof(CONVAL), 0, 1, "i", "bii", (SUBR)conval, NULL, NULL,
     NULL},
    {":cond.k", sizeof(CONVAL), 0, 2, "k", "Bkk", NULL, (SUBR)conval, NULL,
     NULL},
    {":cond.s", sizeof(CONVAL), 0, 1, "S", "bSS", (SUBR)conval, NULL, NULL,
     NULL},
    {":cond.S", sizeof(CONVAL), 0, 3, "S", "BSS", (SUBR)conval, (SUBR)conval,
     NULL, NULL},
    {"<", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)lt, (SUBR)lt, NULL, NULL},
    {"<.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)lt, (SUBR)lt, NULL, NULL},
    {"<=", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)le, (SUBR)le, NULL, NULL},
    {"<=.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)le, (SUBR)le, NULL, NULL},
    {"=.a", sizeof(ASSIGN), 0, 2, "a", "a", NULL, (SUBR)gaassign, NULL, NULL},
    {"=.i", sizeof(ASSIGNM), 0, 1, "IIIIIIIIIIIIIIIIIIIIIIII", "m", (SUBR)minit,
     NULL, NULL, NULL},
    {"=.k", sizeof(ASSIGNM), 0, 2, "zzzzzzzzzzzzzzzzzzzzzzzz", "z", NULL,
     (SUBR)minit, NULL, NULL},
    {"=.l", sizeof(ASSIGN), 0, 2, "a", "a", NULL, (SUBR)laassign, NULL, NULL},
    {"=.r", sizeof(ASSIGN), 0, 1, "r", "i", (SUBR)rassign, NULL, NULL, NULL},
    {"==", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)eq, (SUBR)eq, NULL, NULL},
    {"==.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)eq, (SUBR)eq, NULL, NULL},
    {">", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)gt, (SUBR)gt, NULL, NULL},
    {">.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)gt, (SUBR)gt, NULL, NULL},
    {">=", sizeof(RELAT), 0, 0, "b", "ii", (SUBR)ge, (SUBR)ge, NULL, NULL},
    {">=.0", sizeof(RELAT), 0, 0, "B", "kk", (SUBR)ge, (SUBR)ge, NULL, NULL},
    {"_in", sizeof(INALL), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm", "",
     (SUBR)inch_set, (SUBR)inall_opcode, NULL, NULL},
    {"abs.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)absa, NULL, NULL},
    {"abs.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)abs1, NULL, NULL, NULL},
    {"abs.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)abs1, NULL, NULL},
    {"ampdb.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)aampdb, NULL, NULL},
    {"ampdb.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ampdb, NULL, NULL, NULL},
    {"ampdb.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)ampdb, NULL, NULL},
    {"ampdbfs.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)aampdbfs, NULL,
     NULL},
    {"ampdbfs.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ampdbfs, NULL, NULL,
     NULL},
    {"ampdbfs.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)ampdbfs, NULL,
     NULL},
    {"birnd.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)birnd1, NULL, NULL, NULL},
    {"birnd.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)birnd1, NULL, NULL},
    {"ceil.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)int1a_ceil, NULL,
     NULL},
    {"ceil.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)int1_ceil, NULL, NULL, NULL},
    {"ceil.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)int1_ceil, NULL, NULL},
    {"cent.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)acent, NULL, NULL},
    {"cent.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cent, NULL, NULL, NULL},
    {"cent.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cent, NULL, NULL},
    {"cos.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)cosa, NULL, NULL},
    {"cos.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cos1, NULL, NULL, NULL},
    {"cos.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cos1, NULL, NULL},
    {"cosh.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)cosha, NULL, NULL},
    {"cosh.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cosh1, NULL, NULL, NULL},
    {"cosh.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cosh1, NULL, NULL},
    {"cosinv.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)acosa, NULL, NULL},
    {"cosinv.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)acos1, NULL, NULL, NULL},
    {"cosinv.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)acos1, NULL, NULL},
    {"cps2pch", sizeof(XENH), TR, 1, "i", "ii", (SUBR)cps2pch, NULL, NULL,
     NULL},
    {"cpsmidinn.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cpsmidinn, NULL, NULL,
     NULL},
    {"cpsmidinn.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cpsmidinn, NULL,
     NULL},
    {"cpsoct.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)acpsoct, NULL, NULL},
    {"cpsoct.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cpsoct, NULL, NULL, NULL},
    {"cpsoct.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cpsoct, NULL, NULL},
    {"cpspch.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)cpspch, NULL, NULL, NULL},
    {"cpspch.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)cpspch, NULL, NULL},
    {"cpstun", sizeof(CPSTUN), TR, 2, "k", "kkk", NULL, (SUBR)cpstun, NULL,
     NULL},
    {"cpstuni", sizeof(CPSTUNI), TR, 1, "i", "ii", (SUBR)cpstun_i, NULL, NULL,
     NULL},
    {"cpsxpch", sizeof(XENH), TR, 1, "i", "iiii", (SUBR)cpsxpch, NULL, NULL,
     NULL},
    {"db.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)dba, NULL, NULL},
    {"db.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)db, NULL, NULL, NULL},
    {"db.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)db, NULL, NULL},
    {"dbamp.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)dbamp, NULL, NULL, NULL},
    {"dbamp.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)dbamp, NULL, NULL},
    {"dbfsamp.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)dbfsamp, NULL, NULL},
    {"dbfsamp.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)dbfsamp, NULL,
     NULL},
    {"divz.aa", sizeof(DIVZ), 0, 2, "a", "aak", NULL, (SUBR)divzaa, NULL, NULL},
    {"divz.ak", sizeof(DIVZ), 0, 2, "a", "akk", NULL, (SUBR)divzak, NULL, NULL},
    {"divz.ii", sizeof(DIVZ), 0, 1, "i", "iii", (SUBR)divzkk, NULL, NULL, NULL},
    {"divz.ka", sizeof(DIVZ), 0, 2, "a", "kak", NULL, (SUBR)divzka, NULL, NULL},
    {"divz.kk", sizeof(DIVZ), 0, 2, "k", "kkk", NULL, (SUBR)divzkk, NULL, NULL},
    {"exp.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)expa, NULL, NULL},
    {"exp.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)exp01, NULL, NULL, NULL},
    {"exp.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)exp01, NULL, NULL},
    {"floor.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)int1a_floor, NULL,
     NULL},
    {"floor.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)int1_floor, NULL, NULL,
     NULL},
    {"floor.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)int1_floor, NULL,
     NULL},
    {"frac.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)frac1a, NULL, NULL},
    {"frac.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)frac1, NULL, NULL, NULL},
    {"frac.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)frac1, NULL, NULL},
    {"ftchnls.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ftchnls, NULL, NULL,
     NULL},
    {"ftcps.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ftcps, NULL, NULL, NULL},
    {"ftlen.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ftlen, NULL, NULL, NULL},
    {"ftlptim.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ftlptim, NULL, NULL,
     NULL},
    {"ftsr.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ftsr, NULL, NULL, NULL},
    {"i.i", sizeof(ASSIGN), 0, 1, "i", "i", (SUBR)assign, NULL, NULL, NULL},
    {"i.k", sizeof(ASSIGN), 0, 1, "i", "k", (SUBR)assign, NULL, NULL, NULL},
    {"in32", sizeof(INALL), 0, 2, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "", NULL,
     (SUBR)in32, NULL, NULL},
    {"in.A", sizeof(INA), 0, 2, "a[]", "", NULL, (SUBR)inarray, NULL, NULL},
    {"in.a", sizeof(INM), 0, 2, "a", "", NULL, (SUBR)in, NULL, NULL},
    {"in.s", sizeof(INS), 0, 2, "aa", "", NULL, (SUBR)ins, NULL, NULL},
    {"inch", sizeof(INCH1), 0, 3, "a", "k", (SUBR)inch1_set, (SUBR)inch_opcode1,
     NULL, NULL},
    {"inch.m", sizeof(INCH), 0, 3, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
     "z", (SUBR)inch_set, (SUBR)inch_opcode, NULL, NULL},
    {"inh", sizeof(INH), 0, 2, "aaaaaa", "", NULL, (SUBR)inh, NULL, NULL},
    {"init.a", sizeof(ASSIGNM), 0, 1, "mmmmmmmmmmmmmmmmmmmmmmmm", "m",
     (SUBR)mainit, NULL, NULL, NULL},
    {"init.i", sizeof(ASSIGNM), 0, 1, "IIIIIIIIIIIIIIIIIIIIIIII", "m",
     (SUBR)minit, NULL, NULL, NULL},
    {"init.k", sizeof(ASSIGNM), 0, 1, "zzzzzzzzzzzzzzzzzzzzzzzz", "m",
     (SUBR)minit, NULL, NULL, NULL},
    {"ino", sizeof(INO), 0, 2, "aaaaaaaa", "", NULL, (SUBR)ino, NULL, NULL},
    {"inq", sizeof(INQ), 0, 2, "aaaa", "", NULL, (SUBR)inq, NULL, NULL},
    {"ins", sizeof(INS), 0, 2, "aa", "", NULL, (SUBR)ins, NULL, NULL},
    {"int.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)int1a, NULL, NULL},
    {"int.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)int1, NULL, NULL, NULL},
    {"int.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)int1, NULL, NULL},
    {"inx", sizeof(INALL), 0, 2, "aaaaaaaaaaaaaaaa", "", NULL, (SUBR)in16, NULL,
     NULL},
    {"k.i", sizeof(ASSIGN), 0, 1, "k", "i", (SUBR)assign, NULL, NULL, NULL},
    {"log2.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)log2a, NULL, NULL},
    {"log2.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)log21, NULL, NULL, NULL},
    {"log2.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)log21, NULL, NULL},
    {"log10.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)log10a, NULL, NULL},
    {"log10.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)log101, NULL, NULL, NULL},
    {"log10.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)log101, NULL, NULL},
    {"log.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)loga, NULL, NULL},
    {"log.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)log01, NULL, NULL, NULL},
    {"log.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)log01, NULL, NULL},
    {"logbtwo.a", sizeof(EVAL), 0, 3, "a", "a", (SUBR)logbasetwo_set,
     (SUBR)logbasetwoa, NULL, NULL},
    {"logbtwo.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)ilogbasetwo, NULL, NULL,
     NULL},
    {"logbtwo.k", sizeof(EVAL), 0, 3, "k", "k", (SUBR)logbasetwo_set,
     (SUBR)logbasetwo, NULL, NULL},
    {"nsamp.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)numsamp, NULL, NULL, NULL},
    {"octave.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)powoftwoa, NULL,
     NULL},
    {"octave.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)powoftwo, NULL, NULL,
     NULL},
    {"octave.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)powoftwo, NULL,
     NULL},
    {"octcps.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)octcps, NULL, NULL, NULL},
    {"octcps.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)octcps, NULL, NULL},
    {"octmidinn.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)octmidinn, NULL, NULL,
     NULL},
    {"octmidinn.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)octmidinn, NULL,
     NULL},
    {"octpch.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)octpch, NULL, NULL, NULL},
    {"octpch.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)octpch, NULL, NULL},
    {"out32", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"out.A", sizeof(OUTARRAY), IR, 3, "", "a[]", (SUBR)outarr_init,
     (SUBR)outarr, NULL, NULL},
    {"out.a", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outall", sizeof(OUTM), IR, 2, "", "a", NULL, (SUBR)outrep, NULL, NULL},
    {"outc", sizeof(OUTX), IR, 2, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outch", sizeof(OUTCH), IR, 2, "", "Z", NULL, (SUBR)outch, NULL, NULL},
    {"outh", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outo", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outq1", sizeof(OUTM), IR, 2, "", "a", NULL, (SUBR)outs1, NULL, NULL},
    {"outq2", sizeof(OUTM), IR, 3, "", "a", (SUBR)och2, (SUBR)outs2, NULL,
     NULL},
    {"outq3", sizeof(OUTM), IR, 3, "", "a", (SUBR)och3, (SUBR)outq3, NULL,
     NULL},
    {"outq4", sizeof(OUTM), IR, 3, "", "a", (SUBR)och2, (SUBR)outq4, NULL,
     NULL},
    {"outq", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outs1", sizeof(OUTM), IR, 2, "", "a", NULL, (SUBR)outs1, NULL, NULL},
    {"outs2", sizeof(OUTM), IR, 3, "", "a", (SUBR)och2, (SUBR)outs2, NULL,
     NULL},
    {"outs", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"outx", sizeof(OUTX), IR, 3, "", "y", (SUBR)ochn, (SUBR)outall, NULL,
     NULL},
    {"pchmidinn.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)pchmidinn, NULL, NULL,
     NULL},
    {"pchmidinn.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)pchmidinn, NULL,
     NULL},
    {"pchoct.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)pchoct, NULL, NULL, NULL},
    {"pchoct.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)pchoct, NULL, NULL},
    {"powoftwo.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)powoftwoa, NULL,
     NULL},
    {"powoftwo.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)powoftwo, NULL, NULL,
     NULL},
    {"powoftwo.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)powoftwo, NULL,
     NULL},
    {"qinf.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)is_infa, NULL, NULL},
    {"qinf.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)is_inf, NULL, NULL, NULL},
    {"qinf.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)is_inf, NULL, NULL},
    {"qnan.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)is_NaNa, NULL, NULL},
    {"qnan.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)is_NaN, NULL, NULL, NULL},
    {"qnan.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)is_NaN, NULL, NULL},
    {"rnd.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)rnd1, NULL, NULL, NULL},
    {"rnd.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)rnd1, NULL, NULL},
    {"rndseed", sizeof(EVAL), 0, 1, "", "i", (SUBR)rnd1seed, NULL, NULL, NULL},
    {"round.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)int1a_round, NULL,
     NULL},
    {"round.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)int1_round, NULL, NULL,
     NULL},
    {"round.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)int1_round, NULL,
     NULL},
    {"rtclock.i", sizeof(EVAL), 0, 1, "i", "", (SUBR)rtclock, NULL, NULL},
    {"rtclock.k", sizeof(EVAL), 0, 2, "k", "", NULL, (SUBR)rtclock, NULL, NULL},
    {"semitone.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)asemitone, NULL,
     NULL},
    {"semitone.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)semitone, NULL, NULL,
     NULL},
    {"semitone.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)semitone, NULL,
     NULL},
    {"signum.a", sizeof(ASSIGN), 0, 2, "a", "a", NULL, (SUBR)asignum, NULL,
     NULL},
    {"signum.i", sizeof(ASSIGN), 0, 1, "i", "i", (SUBR)signum, NULL, NULL,
     NULL},
    {"signum.k", sizeof(ASSIGN), 0, 3, "k", "k", (SUBR)signum, (SUBR)signum,
     NULL, NULL},
    {"sin.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)sina, NULL, NULL},
    {"sin.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)sin1, NULL, NULL, NULL},
    {"sin.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)sin1, NULL, NULL},
    {"sinh.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)sinha, NULL, NULL},
    {"sinh.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)sinh1, NULL, NULL, NULL},
    {"sinh.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)sinh1, NULL, NULL},
    {"sininv.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)asina, NULL, NULL},
    {"sininv.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)asin1, NULL, NULL, NULL},
    {"sininv.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)asin1, NULL, NULL},
    {"sqrt.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)sqrta, NULL, NULL},
    {"sqrt.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)sqrt1, NULL, NULL, NULL},
    {"sqrt.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)sqrt1, NULL, NULL},
    {"tan.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)tana, NULL, NULL},
    {"tan.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)tan1, NULL, NULL, NULL},
    {"tan.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)tan1, NULL, NULL},
    {"tanh.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)tanha, NULL, NULL},
    {"tanh.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)tanh1, NULL, NULL, NULL},
    {"tanh.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)tanh1, NULL, NULL},
    {"taninv2.a", sizeof(AOP), 0, 2, "a", "aa", NULL, (SUBR)atan2aa, NULL,
     NULL},
    {"taninv2.i", sizeof(AOP), 0, 1, "i", "ii", (SUBR)atan21, NULL, NULL, NULL},
    {"taninv2.k", sizeof(AOP), 0, 2, "k", "kk", NULL, (SUBR)atan21, NULL, NULL},
    {"taninv.a", sizeof(EVAL), 0, 2, "a", "a", NULL, (SUBR)atana, NULL, NULL},
    {"taninv.i", sizeof(EVAL), 0, 1, "i", "i", (SUBR)atan1, NULL, NULL, NULL},
    {"taninv.k", sizeof(EVAL), 0, 2, "k", "k", NULL, (SUBR)atan1, NULL, NULL},
    {"||", sizeof(LOGCL), 0, 0, "b", "bb", (SUBR) or, (SUBR) or, NULL, NULL},
    {"||.0", sizeof(LOGCL), 0, 0, "B", "BB", (SUBR) or, (SUBR) or, NULL, NULL},
};

LINKAGE_BUILTIN(aops_localops)