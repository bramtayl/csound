...
static OENTRY localops[] =
  {
   { "dconv",  S(DCONV), TR, 3, "a", "aii",   (SUBR)dconvset, (SUBR)dconv, NULL, NULL},
   { "vcomb", S(VCOMB),  0,3, "a", "akxioo", (SUBR)vcombset, (SUBR)vcomb, NULL, NULL},
   { "valpass", S(VCOMB),0,3, "a", "akxioo", (SUBR)vcombset, (SUBR)valpass, NULL, NULL},
   { "ftmorf", S(FTMORF),TR, 3, "",  "kii",  (SUBR)ftmorfset,  (SUBR)ftmorf, NULL, NULL},
   { "##and.ii",  S(AOP),  0,1, "i", "ii",   (SUBR)and_kk, NULL, NULL, NULL},
   { "##and.kk",  S(AOP),  0,2, "k", "kk",   NULL,   (SUBR)and_kk, NULL, NULL},
   { "##and.ka",  S(AOP),  0,2, "a", "ka",   NULL,   (SUBR)and_ka, NULL, NULL},
   { "##and.ak",  S(AOP),  0,2, "a", "ak",   NULL,   (SUBR)and_ak, NULL, NULL},
   { "##and.aa",  S(AOP),  0,2, "a", "aa",   NULL,   (SUBR)and_aa, NULL, NULL},
   { "##or.ii",   S(AOP),  0,1, "i", "ii",   (SUBR)or_kk, NULL, NULL, NULL},
   { "##or.kk",   S(AOP),  0,2, "k", "kk",   NULL,   (SUBR)or_kk, NULL, NULL},
   { "##or.ka",   S(AOP),  0,2, "a", "ka",   NULL,   (SUBR)or_ka, NULL, NULL},
   { "##or.ak",   S(AOP),  0,2, "a", "ak",   NULL,   (SUBR)or_ak, NULL, NULL},
   { "##or.aa",   S(AOP),  0,2, "a", "aa",   NULL,   (SUBR)or_aa, NULL, NULL},
   { "##xor.ii",  S(AOP),  0,1, "i", "ii",   (SUBR)xor_kk, NULL, NULL, NULL},
   { "##xor.kk",  S(AOP),  0,2, "k", "kk",   NULL,   (SUBR)xor_kk, NULL, NULL},
   { "##xor.ka",  S(AOP),  0,2, "a", "ka",   NULL,   (SUBR)xor_ka, NULL, NULL},
   { "##xor.ak",  S(AOP),  0,2, "a", "ak",   NULL,   (SUBR)xor_ak, NULL, NULL},
   { "##xor.aa",  S(AOP),  0,2, "a", "aa",   NULL,   (SUBR)xor_aa, NULL, NULL},
   { "##not.i",   S(AOP),  0,1, "i", "i",    (SUBR)not_k, NULL, NULL, NULL},
   { "##not.k",   S(AOP),  0,2, "k", "k",    NULL,   (SUBR)not_k, NULL, NULL},
   { "##not.a",   S(AOP),  0,2, "a", "a",    NULL,   (SUBR)not_a, NULL, NULL},
   { "##shl.ii",  S(AOP),  0,1, "i", "ii",   (SUBR) shift_left_kk, NULL, NULL, NULL},
   { "##shl.kk",  S(AOP),  0,2, "k", "kk",   NULL, (SUBR) shift_left_kk, NULL, NULL},
   { "##shl.ka", S(AOP), 0,2, "a", "ka", NULL, (SUBR) shift_left_ka, NULL, NULL},
   { "##shl.ak", S(AOP), 0,2, "a", "ak", NULL, (SUBR) shift_left_ak, NULL, NULL},
   { "##shl.aa", S(AOP), 0,2, "a", "aa", NULL, (SUBR) shift_left_aa, NULL, NULL},
   { "##shr.ii",  S(AOP),  0,1, "i", "ii",   (SUBR) shift_right_kk, NULL, NULL, NULL},
   { "##shr.kk",  S(AOP),  0,2, "k", "kk",   NULL, (SUBR) shift_right_kk, NULL, NULL},
   { "##shr.ka", S(AOP), 0,2, "a", "ka", NULL, (SUBR) shift_right_ka, NULL, NULL},
   { "##shr.ak", S(AOP), 0,2, "a", "ak", NULL, (SUBR) shift_right_ak, NULL, NULL},
