...
static OENTRY physmod_localops[] =
  {
   { "wgclar",  S(CLARIN),TR, 3, "a", "kkkiikkkjo",(SUBR)clarinset, (SUBR)clarin, NULL, NULL},
   { "wgflute", S(FLUTE), TR, 3, "a", "kkkiikkkjovv",(SUBR)fluteset, (SUBR)flute, NULL, NULL},
   { "wgbow",   S(BOWED), TR, 3, "a", "kkkkkkjo", (SUBR)bowedset,   (SUBR)bowed, NULL, NULL},
   { "wgbrass", S(BRASS), TR, 3, "a", "kkkikkjo", (SUBR)brassset,    (SUBR)brass, NULL, NULL},
   { "mandol", S(MANDOL), TR, 3, "a", "kkkkkkio",(SUBR)mandolinset,(SUBR)mandolin, NULL, NULL},
   { "voice", S(VOICF),   TR, 3, "a", "kkkkkkii",(SUBR)voicformset,(SUBR)voicform, NULL, NULL},
   { "fmbell",  S(FM4OP), TR, 3, "a", "kkkkkkjjjjjo",
     (SUBR)tubebellset,(SUBR)tubebell, NULL, NULL},
   { "fmrhode", S(FM4OP), TR, 3, "a", "kkkkkkiiiii",(SUBR)rhodeset,(SUBR)tubebell, NULL, NULL},
   { "fmwurlie", S(FM4OP),TR, 3, "a", "kkkkkkiiiii",(SUBR)wurleyset,(SUBR)wurley, NULL, NULL},
   { "fmmetal", S(FM4OP), TR, 3, "a", "kkkkkkiiiii",
     (SUBR)heavymetset, (SUBR)heavymet, NULL, NULL},
   { "fmb3", S(FM4OP),    TR, 3, "a", "kkkkkkjjjjj", (SUBR)b3set,(SUBR)hammondB3, NULL, NULL},
   { "fmvoice", S(FM4OPV),TR, 3, "a", "kkkkkkjjjjj",
     (SUBR)FMVoiceset,(SUBR)FMVoice, NULL, NULL},
   { "fmpercfl", S(FM4OP),TR, 3, "a", "kkkkkkjjjjj",
     (SUBR)percfluteset, (SUBR)percflute, NULL, NULL},
   { "moog", S(MOOG1),    TR, 3, "a", "kkkkkkiii", (SUBR)Moog1set, (SUBR)Moog1, NULL, NULL},
   { "shaker", S(SHAKER), 0, 3, "a", "kkkkko",  (SUBR)shakerset,   (SUBR)shaker, NULL, NULL},
   { "wgbowedbar", S(BOWEDBAR), 0, 3, "a","kkkkkoooo",
     (SUBR)bowedbarset,(SUBR) bowedbar, NULL, NULL},
};
