...
#include <string.h>            // for memset, memcpy, strcmp, strcpy, strlen

#include "interlocks.h"        // for TR, TW
#include "Opcodes/stdopcod.h"  // for ATSBUFREAD, STDOPCOD_GLOBALS, ugnorman...
#include "csound.h"            // for CSOUND, Str, CSFTYPE_ATS
